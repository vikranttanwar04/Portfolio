    ...
    return(
        <div id='contact-body'>
            ...
            <div>
                ...
                <form method="post" action='https://formsubmit.co/vikranttanwar124108@gmail.com' onSubmit={handleSubmit}>
                    <div className='row input-boxes'>
                        <input className="p-2 me-1 mb-2 col-2 offset-4" type="text" placeholder="Name" name="user" value={formData.user} onChange={inputController} required/>
                        <input className="p-2 mb-2 col-2" type="email" placeholder="Email" name="email" value={formData.email} onChange={inputController} required/>
                    </div>

                    <div className='msg-box row'>
                        <textarea className="p-2 mb-2 col-4 offset-4" rows="5" cols="44" placeholder="Message" name="msg" value={formData.msg} onChange={inputController} required/><br />
                    </div>
                    <div className='row'>
